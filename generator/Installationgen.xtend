...
//
define('JPATH_MDD',	JPATH_ROOT.'/mddsql');


  if (file_exists(JPATH_MDD.'/com/application.sql')) {
    header('Location: '.substr($_SERVER['REQUEST_URI'], 0, strpos($_SERVER['REQUEST_URI'], 'index.php')).'mddsql/index.php');
    exit();
  }
...
<html>
<head>
<title>Login Page MDD 2014</title>
...
<form action="<?php echo "index.php";?>" method="get" >
 ...
 <label >Benutzer Name:  	 </label><input type="text"  autocomplete="on" title="Benutzer Name" name="username" min="155"> <br />
 <label >Benutzer PassWord:  </label> <input type="text" name="pass" title="Benutzer Password" min="155"> <br />
